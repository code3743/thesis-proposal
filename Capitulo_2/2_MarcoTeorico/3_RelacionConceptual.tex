...
\end{tikzpicture}
\caption{Relación conceptual entre los componentes del proceso de interpretación en el modelo EOPL. La fila superior muestra el pipeline de análisis (tiempo de compilación); la fila inferior, el pipeline de ejecución (tiempo de evaluación).}
