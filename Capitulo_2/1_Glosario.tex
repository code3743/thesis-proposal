...
\begin{itemize}
    ...
    Modelo de ambiente en el que los valores se almacenan en celdas mutables representadas mediante referencias, y el ambiente contiene punteros a dichas celdas. Este modelo habilita la asignación destructiva mediante \texttt{set} sin crear un nuevo marco en el ambiente \cite{Friedman2008EPL}.

    \item \textbf{Resultado de aprendizaje (R.A.):}
    Componente del microcurrículo de la asignatura FLP que describe una competencia general que el estudiante debe alcanzar al finalizar el curso. Cada R.A. se desglosa en varios indicadores de logro (IL), con pesos evaluativos diferenciados sobre la nota total de la asignatura.
