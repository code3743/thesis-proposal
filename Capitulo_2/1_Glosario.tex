...
\begin{itemize}
    ...
    \item \textbf{Resultado de aprendizaje (RA):}
    Componente del microcurrículo de la asignatura FLP que describe una competencia general que el estudiante debe alcanzar al finalizar el curso. Cada RA se desglosa en varios indicadores de logro (IL), con pesos evaluativos diferenciados sobre la nota total de la asignatura.
