...
\begin{itemize}
    ...
    \item Interfaz accesible que promueva la exploración y el aprendizaje autónomo.
    \item Inclusión de ejemplos predefinidos que ilustren conceptos centrales de la asignatura.
    \item Almacenamiento local de gramáticas y programas definidos por el usuario para su reutilización.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Evaluación:} validación de usabilidad mediante pruebas con estudiantes y el docente de la asignatura.
\end{itemize}
