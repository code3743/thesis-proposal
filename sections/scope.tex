...
\subsubsection{Contribución proyectada}

La herramienta propuesta en este proyecto busca posicionarse en un punto intermedio entre los entornos didácticos —caracterizados por su simplicidad y enfoque pedagógico— y los entornos profesionales, que suelen ser más potentes pero menos accesibles para el aprendizaje inicial. En correspondencia con los objetivos planteados, la propuesta se centra en tres ejes fundamentales:

\begin{enumerate}[label=(\roman*)]
    \item \textbf{Visualización de procesos internos}: mediante representaciones gráficas de las etapas de interpretación y compilación, la herramienta permitirá observar la construcción del árbol de sintaxis abstracta (AST) y la evolución de los entornos de ejecución, favoreciendo la comprensión de los mecanismos internos de un compilador \cite{jovanovic2021comvis,stamenkovic2024web}.
    
    \item \textbf{Apoyo didáctico y exploración guiada}: se integrarán estrategias de aprendizaje constructivista y principios de usabilidad educativa que reduzcan la carga cognitiva y promuevan la exploración autónoma de conceptos abstractos \cite{lu2022usability,delvado2023itt}.
    
    \item \textbf{Fortalecimiento del aprendizaje autónomo}: a través de un entorno web accesible, sin necesidad de instalación y con ejemplos progresivos, se fomentará la autoevaluación y la construcción activa del conocimiento en la asignatura \textit{Fundamentos de Interpretación y Compilación de Lenguajes de Programación}.
\end{enumerate}

Con esta estructura, el proyecto busca atender los vacíos identificados en la literatura —particularmente la falta de herramientas integradas, accesibles y orientadas al aprendizaje— y generar evidencia empírica contextualizada en la Universidad del Valle.
