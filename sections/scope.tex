...
\subsection{Marco lógico de la propuesta}

\begin{longtable}{|p{4cm}|p{4.2cm}|p{4.2cm}|p{4.2cm}|}
\hline
\textbf{Objetivos} & 
\textbf{Indicadores Verificables} & 
\textbf{Medios de Verificación} & 
\textbf{Supuestos} \\ \hline
\endfirsthead
...
&
- El docente mantiene apertura al uso de recursos digitales. \\ \hline
...
&
- Disposición del docente y estudiantes para participar en la evaluación. \\ \hline

\multicolumn{4}{|l|}{\textbf{Componentes}} \\ \hline

\textbf{Componente 1} \newline
Diagnóstico de dificultades conceptuales de los estudiantes.
&
- Documento con al menos cinco conceptos clave identificados.
&
- Informe de diagnóstico y revisión de literatura.
&
- Acceso a material académico y colaboración del docente. \\ \hline

\textbf{Componente 2} \newline
Especificación de requisitos funcionales y no funcionales del sistema.
&
- Lista priorizada de 8--12 requisitos funcionales. \newline
- Lista de 5--8 requisitos no funcionales con criterios de aceptación.
&
- Documento de requisitos validado con el docente.
&
- Colaboración del docente en la revisión y validación. \\ \hline

\textbf{Componente 3} \newline
Diseño de la arquitectura, prototipos de interfaz y selección tecnológica.
&
- Documento de arquitectura definido. \newline
- Prototipos de interfaz diseñados. \newline
- Justificación de las tecnologías seleccionadas.
&
- Diagramas, mockups y documentación técnica.
&
- Acceso a herramientas de diseño y documentación. \\ \hline

\textbf{Componente 4} \newline
Prototipo web funcional y desplegado en entorno de pruebas.
&
- Prototipo con implementación de requisitos funcionales. \newline
- Código alojado en un repositorio documentado.
&
- Repositorio GitHub. \newline
- Acceso al entorno de pruebas.
&
- Capacidad técnica para implementación de funcionalidades. \\ \hline

\textbf{Componente 5} \newline
Evaluación de funcionalidad y usabilidad del prototipo.
&
- Cuestionarios aplicados a 10--20 estudiantes. \newline
- Observaciones de uso del prototipo.
&
- Registros de prueba y análisis cualitativo.
&
- Disposición de estudiantes para participar. \\ \hline

\multicolumn{4}{|l|}{\textbf{Actividades}} \\ \hline

\textbf{A1.1 Análisis de material académico y fuentes del curso.} &
- Revisión documental &
- Informe de revisión &
- Acceso a material académico \\ \hline

\textbf{A1.2 Elaboración del diagnóstico de conceptos.} &
- Identificación de conceptos difíciles &
- Selección de ejemplos y observaciones del docente &
- Colaboración del docente y disponibilidad de información \\ \hline

\textbf{A2.1 Identificación preliminar de requisitos.} &
- Identificación de requisitos funcionales y no funcionales &
- Lista preliminar de requisitos &
- Comprensión de las necesidades del prototipo \\ \hline

\textbf{A2.2 Priorización y definición de criterios} &
- Requisitos priorizados y criterios establecidos &
- Documento de criterios de aceptación &
- Retroalimentación del docente disponible \\ \hline

\textbf{A2.3 Validación de requisitos} &
- Requisitos validados con el docente &
- Documento final de requisitos y criterios &
- Colaboración del docente \\ \hline

\textbf{A3.1 Diseño de arquitectura} &
- Arquitectura definida con componentes y flujo de información &
- Documento de arquitectura &
- Acceso a herramientas de diseño y prototipado \\ \hline

\textbf{A3.2 Elaboración de prototipos de interfaz} &
- Mockups de interfaz creados &
- Prototipos y bocetos &
- Disponibilidad de software de diseño y revisión docente \\ \hline

\textbf{A3.3 Selección y justificación de tecnologías} &
- Tecnologías seleccionadas &
- Documento técnico con decisiones y justificación &
- Viabilidad técnica y curva de aprendizaje del equipo \\ \hline

\textbf{A4.1 Implementación del editor de gramáticas} &
- Editor con funciones básicas &
- Repositorio con código y pruebas &
- Estabilidad del entorno de desarrollo \\ \hline

\textbf{A4.2 Implementación del generador y visualizador de AST} &
- AST generados correctamente &
- Repositorio y pruebas funcionales &
- Capacidad técnica del equipo \\ \hline

\textbf{A4.3 Implementación del visualizador de cambios de ambiente} &
- Visualización de cambios en tiempo de ejecución &
- Repositorio y pruebas &
- Entorno compatible y estable \\ \hline

\textbf{A4.4 Integración y despliegue del prototipo} &
- Prototipo funcional en entorno de pruebas &
- Repositorio y demostración funcional &
- Acceso a servicios de alojamiento \\ \hline

\textbf{A5.1 Diseño del protocolo de pruebas} &
- Protocolo definido con objetivos claros &
- Documento de protocolo &
- Disponibilidad de docentes y estudiantes para revisión \\ \hline
