...
Finalmente, investigaciones más recientes como la de Stamenković y Jovanović \cite{Stamenkovic2024AWE} exploran sistemas web interactivos que permiten la enseñanza de compiladores a través de entornos digitales, integrando elementos de visualización, automatización y simulación educativa.
