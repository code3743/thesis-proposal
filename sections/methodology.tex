...
Para el desarrollo del prototipo se adoptará Scrum como marco de trabajo ágil. Aunque Scrum no se considera una metodología rígida de desarrollo de software, su enfoque iterativo basado en ciclos cortos de planificación, ejecución y evaluación lo convierte en una opción adecuada para proyectos que requieren retroalimentación continua y una evolución progresiva del producto. Tras un análisis comparativo de diferentes enfoques de desarrollo (véase el Anexo~\ref{anexo:analisis}), se determinó que Scrum ofrece el equilibrio más favorable entre simplicidad, adaptabilidad y claridad estructural para el contexto académico del proyecto.

El proceso de desarrollo se organizará mediante Sprints de duración fija, en los cuales se definirán objetivos concretos y se desarrollarán incrementos funcionales del sistema. Scrum proporcionará la estructura para gestionar el avance del producto mediante sus artefactos principales: el \textit{Product Backlog}, que consolida los requisitos; el \textit{Sprint Backlog}, que contiene los compromisos de cada iteración; y el \textit{Incremento}, correspondiente al avance verificable generado al final de cada sprint.

Dado el tamaño reducido del equipo, los integrantes asumirán de manera combinada las responsabilidades de \textit{Scrum Master} y \textit{Development Team}, mientras que el director del trabajo de grado actuará como \textit{Product Owner}, definiendo prioridades y validando los entregables.
