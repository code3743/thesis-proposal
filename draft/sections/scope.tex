...
El prototipo se limita a funcionalidades demostrativas orientadas al aprendizaje, cubriendo solo una parte del contenido de la asignatura, particularmente aquellos conceptos que, de acuerdo con la literatura y la experiencia docente, presentan mayores niveles de dificultad para los estudiantes, sin la intención de soportar un lenguaje completo de propósito general ni mecanismos avanzados de ejecución.
...
\input{tables/logical_array.tex}
