...
\paragraph{Utilidad pedagógica.} La Tabla~\ref{tab:utilidad-pedagogica} presenta la distribución de respuestas para los siete ítems del cuestionario de utilidad pedagógica, diseñado a partir de los cinco indicadores de logro seleccionados en el Capítulo 3.
