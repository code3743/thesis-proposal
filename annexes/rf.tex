...
\hline
\textbf{Descripción} & El sistema debe representar el ambiente de evaluación como una estructura jerárquica de marcos que se actualiza en cada ejecución, permitiendo al estudiante observar la evolución del estado del programa. \\
\hline
\textbf{Prioridad} & Alta \\
\hline
\textbf{Criterios de aceptación} &
\begin{itemize}[leftmargin=*,topsep=2pt,itemsep=1pt,parsep=0pt]
    \item El panel EnvironmentPanel muestra el ambiente como una pila de marcos jerárquicos, donde cada marco lista las ligaduras activas con su nombre, valor serializado y tipo de dato inferido.
    ...
    \item La estructura de marcos refleja fielmente la cadena de ambientes construida durante la evaluación, permitiendo al estudiante identificar el alcance léxico de cada variable.
    \item El panel permanece visible y no colapsa ante la ausencia de ligaduras en el ambiente actual.
\end{itemize} \\
\hline
